...
pindir = "/home/lucas/DependableSystemsLab/PINFI-v2/pin-3.0/"
currdir = os.getcwd()
pinbin = pindir + 'pin'
...
instcategorylib = pindir + "source/tools/pinfi/obj-intel64/instcategory" + LIBEXT
instcountlib = pindir +"source/tools/pinfi/obj-intel64/instcount" + LIBEXT
filib = pindir + "source/tools/pinfi/obj-intel64/faultinjection" + LIBEXT
